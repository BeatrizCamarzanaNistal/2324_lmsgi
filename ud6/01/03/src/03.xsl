...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
        ...
        <html>
            <head>
                ...
                <xsl:call-template name="escribirTitulo">
                    <xsl:with-param name="titulo" select="'03 XSLT Beatriz Camarzana'"/>
                </xsl:call-template>
            </head>
            <body>
                <header>
    ...
    <!-- Escribir los elementos del menú con siglas de los módulos-->
    ...
    <!-- Escribir los horarios de cada módulo -->
    ...
    <!--Escribir la tabla según el parámetro sigla-->
